...
import com.safehaven.affirmations.domain.breathing.BreathPhase
import com.safehaven.affirmations.domain.breathing.BreathStructureSpec
import com.safehaven.affirmations.domain.breathing.BreathingPattern
import com.safehaven.affirmations.domain.breathing.BreathingSessionState
import com.safehaven.affirmations.domain.breathing.FillDirection
import com.safehaven.affirmations.domain.breathing.SphereRoleKind
import com.safehaven.affirmations.domain.breathing.computeStructureSpec
...
fun computeStructureLayout(
    ...
    val ladder = when (spec.layoutStrategy) {
        com.safehaven.affirmations.domain.breathing.LayoutStrategy.InterleavedLadder ->
            tryBuildInterleavedLadder(spec, zoneWidth, zoneHeight, zoneTop, width / 2f, scale, zoneFillRatio)
        com.safehaven.affirmations.domain.breathing.LayoutStrategy.FlowChain ->
...
private fun applyPathFill(
    fills: MutableMap<Int, SphereVisualState>,
    path: List<Int>,
    segments: List<com.safehaven.affirmations.domain.breathing.PhaseSegment>,
    elapsedSec: Float,
