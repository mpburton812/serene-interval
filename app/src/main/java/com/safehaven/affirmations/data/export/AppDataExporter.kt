...
class AppDataExporter(
    ...
    private fun buildConfiguration(
        ...
        toolkit: com.safehaven.affirmations.data.ToolkitPrefsSnapshot,
        quickStartTargets: List<com.safehaven.affirmations.domain.quickstart.QuickStartTarget>,
    ...
    private suspend fun buildLivingTreeSection(
        repository: com.safehaven.affirmations.data.LivingTreeRepository,
    ): JSONObject {
