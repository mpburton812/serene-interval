package com.safehaven.affirmations.data.export

import android.content.Context
import com.safehaven.affirmations.data.AffirmationPreferences
...
import com.safehaven.affirmations.data.local.LivingTreePersonEntity
import com.safehaven.affirmations.data.local.LivingTreePersonTagCrossRef
...
import com.safehaven.affirmations.reminder.FutureSelfMessageScheduler
...
class AppDataImporter(
    ...
    private suspend fun importAffirmations(
        array: JSONArray?,
        dao: com.safehaven.affirmations.data.local.AffirmationDao,
        skips: MutableList<ImportSkip>,
    ): Int {
    ...
    private suspend fun importThoughtDumps(
        ...
        dao: com.safehaven.affirmations.data.local.ThoughtDumpDao,
        skips: MutableList<ImportSkip>,
    ): Int {
        if (array == null || array.length() == 0) return 0
    ...
    private suspend fun importFutureSelfMessages(
        array: JSONArray?,
        dao: com.safehaven.affirmations.data.local.FutureSelfMessageDao,
        skips: MutableList<ImportSkip>,
        warnings: MutableList<String>,
    ): Int {
        if (array == null || array.length() == 0) return 0
    ...
    private suspend fun importRefactoringEntries(
        array: JSONArray?,
        dao: com.safehaven.affirmations.data.local.RefactoringEntryDao,
        skips: MutableList<ImportSkip>,
    ): Int {
        if (array == null || array.length() == 0) return 0
        val existing = dao.getAll()
    ...
    private suspend fun importCenterOfGravityEntries(
        array: JSONArray?,
        dao: com.safehaven.affirmations.data.local.CenterOfGravityEntryDao,
        skips: MutableList<ImportSkip>,
    ): Int {
        if (array == null || array.length() == 0) return 0
        val existing = dao.getAll()
    ...
    private suspend fun importMeditationReflections(
        array: JSONArray?,
        dao: com.safehaven.affirmations.data.local.MeditationReflectionDao,
        skips: MutableList<ImportSkip>,
    ): Int {
        if (array == null || array.length() == 0) return 0
        val existing = dao.getAll()
    ...
    private suspend fun importNvcEntries(
        array: JSONArray?,
        dao: com.safehaven.affirmations.data.local.NvcEntryDao,
        skips: MutableList<ImportSkip>,
    ): Int {
        if (array == null || array.length() == 0) return 0
        val existing = dao.getAll()
    ...
    private suspend fun importHeartsEntries(
        array: JSONArray?,
        dao: com.safehaven.affirmations.data.local.HeartsEntryDao,
        skips: MutableList<ImportSkip>,
    ): Int {
        if (array == null || array.length() == 0) return 0
        val existing = dao.getAll()
    ...
    private suspend fun importMoodEntries(
        array: JSONArray?,
        dao: com.safehaven.affirmations.data.local.MoodEntryDao,
        skips: MutableList<ImportSkip>,
    ): Int {
        if (array == null || array.length() == 0) return 0
        dao.clearAll()
